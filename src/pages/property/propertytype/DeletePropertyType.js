...
import { deletePropertytype } from "../../../store/PropertyType/propertytypeSlice";

const DeletePropertyType = ({ setIsDelete, selectedProperty }) => {
  const dispatch = useDispatch();

  const handleDelete = () => {
    dispatch(deletePropertytype(selectedProperty.id));
    setIsDelete(false);
  };
...
        <h2 className="text-xl font-semibold dark:text-white">Delete property</h2>
        <button
...
          Delete {selectedProperty.field_name}
        </h3>
